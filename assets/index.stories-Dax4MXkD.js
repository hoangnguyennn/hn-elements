import{o as j,c as q,k as A}from"./vue.esm-bundler-CcATLbJj.js";import{_ as i}from"./stack-FJwq8AfJ.js";import{_ as N}from"./utils-CB71rvLt.js";import{_ as t}from"./button-ZUezs3Ji.js";const F={xmlns:"http://www.w3.org/2000/svg",width:"18",height:"18",fill:"none"};function G(n,u){return j(),q("svg",F,u[0]||(u[0]=[A('<g clip-path="url(#a)"><g clip-path="url(#b)"><path fill="#fff" d="M13.025 2.547H2v12.906h14V5.522zm-.334 12.086H5.31v-4.02a.41.41 0 0 1 .41-.41h6.562a.41.41 0 0 1 .41.41zm0-7.711H5.31V3.367h5.195v2.735h1.094V3.367h1.093z"></path></g></g><defs><clipPath id="a"><path fill="#fff" d="M0 0h18v18H0z"></path></clipPath><clipPath id="b"><path fill="#fff" d="M2 2h14v14H2z"></path></clipPath></defs>',2)]))}const O={render:G},U={title:"HnButton",component:t},c={render:n=>({components:{HnButton:t},setup(){return{args:n}},template:'<hn-button v-bind="args">Button</hn-button>'}),parameters:{docs:{source:{code:"<hn-button>Button</hn-button>"}}}},a={argTypes:{variant:{control:!1}},render:n=>({components:{HnButton:t,HnStack:i},setup(){return{args:n}},template:`
