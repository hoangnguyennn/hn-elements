...
}`,...(R=(q=t.parameters)==null?void 0:q.docs)==null?void 0:R.source},description:{story:"Sử dụng thuộc tính `label` của `hn-textarea` để thay đổi label của nó.",...(E=(N=t.parameters)==null?void 0:N.docs)==null?void 0:E.description}}};var V,B,D,K,$;s.parameters={...s.parameters,docs:{...(V=s.parameters)==null?void 0:V.docs,source:{originalSource:`{
  args: {
    label: 'Label',
    hint: 'Hint',
    placeholder: 'Hint'
...
}`,...(D=(B=s.parameters)==null?void 0:B.docs)==null?void 0:D.source},description:{story:"Sử dụng thuộc tính `hint` của `hn-textarea` để thay đổi hint của nó.",...($=(K=s.parameters)==null?void 0:K.docs)==null?void 0:$.description}}};var T,F,P,M,_;d.parameters={...d.parameters,docs:{...(T=d.parameters)==null?void 0:T.docs,source:{originalSource:`{
  args: {
    label: 'Label',
    error: 'Error',
    placeholder: 'Error'
...
}`,...(P=(F=d.parameters)==null?void 0:F.docs)==null?void 0:P.source},description:{story:"Sử dụng thuộc tính `error` của `hn-textarea` để thay đổi error của nó.",...(_=(M=d.parameters)==null?void 0:M.docs)==null?void 0:_.description}}};var O,A,I,U,j;i.parameters={...i.parameters,docs:{...(O=i.parameters)==null?void 0:O.docs,source:{originalSource:`{
  args: {
    label: 'Label',
    disabled: true,
