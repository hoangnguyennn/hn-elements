...
</hn-popover>`}}}},s={args:{placement:"bottom-end"},parameters:{docs:{source:{code:`<hn-popover placement="bottom-end">
  <template #anchor>
    <hn-button>Hover me</hn-button>
  </template>
  <template #content>
...
</hn-popover>`}}}},p={args:{trigger:"click"},parameters:{docs:{source:{code:`<hn-popover trigger="click">
  <template #anchor>
...
</hn-popover>`}}}};var P,_,x;c.parameters={...c.parameters,docs:{...(P=c.parameters)==null?void 0:P.docs,source:{originalSource:`{
  parameters: {
    docs: {
      source: {
        code: \`<hn-popover>
...
}`,...(x=(_=c.parameters)==null?void 0:_.docs)==null?void 0:x.source}}};var T,C,V,q,O;r.parameters={...r.parameters,docs:{...(T=r.parameters)==null?void 0:T.docs,source:{originalSource:`{
  args: {
    arrow: true
  },
  parameters: {
...
}`,...(V=(C=r.parameters)==null?void 0:C.docs)==null?void 0:V.source},description:{story:"Sử dụng thuộc tính `arrow` của `hn-popover` để hiển thị ký hiệu arrow trên `hn-popover-content`.",...(O=(q=r.parameters)==null?void 0:q.docs)==null?void 0:O.description}}};var H,S,N,E,R;s.parameters={...s.parameters,docs:{...(H=s.parameters)==null?void 0:H.docs,source:{originalSource:`{
  args: {
