...
}`,...(V=(C=r.parameters)==null?void 0:C.docs)==null?void 0:V.source},description:{story:"Sử dụng thuộc tính `arrow` của `hn-popover` để hiển thị ký hiệu arrow trên `hn-popover-content`.",...(q=(H=r.parameters)==null?void 0:H.docs)==null?void 0:q.description}}};var O,S,N,R,$;s.parameters={...s.parameters,docs:{...(O=s.parameters)==null?void 0:O.docs,source:{originalSource:`{
  args: {
    placement: 'top'
  },
  parameters: {
...
}`,...(N=(S=s.parameters)==null?void 0:S.docs)==null?void 0:N.source},description:{story:"Sử dụng thuộc tính `placement` của `hn-popover` để thay đổi hướng của `hn-popover-content`.",...($=(R=s.parameters)==null?void 0:R.docs)==null?void 0:$.description}}};var B,E,A,M,j;p.parameters={...p.parameters,docs:{...(B=p.parameters)==null?void 0:B.docs,source:{originalSource:`{
  args: {
    trigger: 'click'
  },
  render: args => ({
...
}`,...(A=(E=p.parameters)==null?void 0:E.docs)==null?void 0:A.source},description:{story:"Sử dụng thuộc tính `trigger` của `hn-popover` để thay đổi hành vi để mở `hn-popover-content`.",...(j=(M=p.parameters)==null?void 0:M.docs)==null?void 0:j.description}}};const we=["Cover","Arrow","Placement","Trigger"];export{r as Arrow,c as Cover,s as Placement,p as Trigger,we as __namedExportsOrder,ke as default};
