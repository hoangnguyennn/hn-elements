...
}`,...(T=(P=d.parameters)==null?void 0:P.docs)==null?void 0:T.source},description:{story:"Sử dụng thuộc tính `error` của `hn-textarea` để thay đổi error của nó.",...(_=(M=d.parameters)==null?void 0:M.docs)==null?void 0:_.description}}};var O,I,j,A,U;i.parameters={...i.parameters,docs:{...(O=i.parameters)==null?void 0:O.docs,source:{originalSource:`{
  args: {
    label: 'Label',
    disabled: true,
...
}`,...(j=(I=i.parameters)==null?void 0:I.docs)==null?void 0:j.source},description:{story:"Sử dụng thuộc tính `disabled` của `hn-textarea` để vô hiệu hoá nó.",...(U=(A=i.parameters)==null?void 0:A.docs)==null?void 0:U.description}}};var G,J,Q,W,X;o.parameters={...o.parameters,docs:{...(G=o.parameters)==null?void 0:G.docs,source:{originalSource:`{
  args: {
    label: 'Label',
    showCounter: true,
    placeholder: 'Counter'
