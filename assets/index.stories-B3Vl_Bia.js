...
}`,...(D=(B=s.parameters)==null?void 0:B.docs)==null?void 0:D.source},description:{story:"Sử dụng thuộc tính `hint` của `hn-textarea` để thay đổi hint của nó.",...($=(K=s.parameters)==null?void 0:K.docs)==null?void 0:$.description}}};var F,P,T,M,O;d.parameters={...d.parameters,docs:{...(F=d.parameters)==null?void 0:F.docs,source:{originalSource:`{
  args: {
    label: 'Label',
    error: 'Error',
    placeholder: 'Error'
...
}`,...(T=(P=d.parameters)==null?void 0:P.docs)==null?void 0:T.source},description:{story:"Sử dụng thuộc tính `error` của `hn-textarea` để thay đổi error của nó.",...(O=(M=d.parameters)==null?void 0:M.docs)==null?void 0:O.description}}};var _,A,I,G,U;i.parameters={...i.parameters,docs:{...(_=i.parameters)==null?void 0:_.docs,source:{originalSource:`{
  args: {
    label: 'Label',
    disabled: true,
...
}`,...(I=(A=i.parameters)==null?void 0:A.docs)==null?void 0:I.source},description:{story:"Sử dụng thuộc tính `disabled` của `hn-textarea` để vô hiệu hoá nó.",...(U=(G=i.parameters)==null?void 0:G.docs)==null?void 0:U.description}}};var j,J,Q,W,X;o.parameters={...o.parameters,docs:{...(j=o.parameters)==null?void 0:j.docs,source:{originalSource:`{
  args: {
    label: 'Label',
    showCounter: true,
    placeholder: 'Counter'
