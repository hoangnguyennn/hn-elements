...
}`,...(m=(h=t.parameters)==null?void 0:h.docs)==null?void 0:m.source}}};var p,f,b,y,g;e.parameters={...e.parameters,docs:{...(p=e.parameters)==null?void 0:p.docs,source:{originalSource:`{
  args: {
    showLabel: true
  },
  parameters: {
...
}`,...(b=(f=e.parameters)==null?void 0:f.docs)==null?void 0:b.source},description:{story:"Sử dụng prop `show-label` của `hn-switch` để hiển thị label của trạng thái hiện tại.",...(g=(y=e.parameters)==null?void 0:y.docs)==null?void 0:g.description}}};var w,k,v,O,C;n.parameters={...n.parameters,docs:{...(w=n.parameters)==null?void 0:w.docs,source:{originalSource:`{
  args: {
    disabled: true
  },
  parameters: {
...
}`,...(v=(k=n.parameters)==null?void 0:k.docs)==null?void 0:v.source},description:{story:"Sử dụng prop `disabled` của `hn-switch` để vô hiệu hoá nó.",...(C=(O=n.parameters)==null?void 0:O.docs)==null?void 0:C.description}}};var L,V,B;o.parameters={...o.parameters,docs:{...(L=o.parameters)==null?void 0:L.docs,source:{originalSource:`{
  args: {
    showLabel: true,
    labelOn: 'Bật',
    labelOff: 'Tắt'
...
}`,...(B=(V=o.parameters)==null?void 0:V.docs)==null?void 0:B.source}}};const j=["Cover","ShowLabel","Disabled","CustomLabel"];export{t as Cover,o as CustomLabel,n as Disabled,e as ShowLabel,j as __namedExportsOrder,U as default};
