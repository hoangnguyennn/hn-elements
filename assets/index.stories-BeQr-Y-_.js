...
}`,...(T=(P=d.parameters)==null?void 0:P.docs)==null?void 0:T.source},description:{story:"Sử dụng thuộc tính `error` của `hn-textarea` để thay đổi error của nó.",...(_=(M=d.parameters)==null?void 0:M.docs)==null?void 0:_.description}}};var O,A,I,G,U;i.parameters={...i.parameters,docs:{...(O=i.parameters)==null?void 0:O.docs,source:{originalSource:`{
  args: {
    label: 'Label',
    disabled: true,
