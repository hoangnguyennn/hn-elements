...
}`,...(I=(F=d.parameters)==null?void 0:F.docs)==null?void 0:I.source},description:{story:"Sử dụng thuộc tính `hint` của `hn-textarea` để thay đổi hint của nó.",...(P=(K=d.parameters)==null?void 0:K.docs)==null?void 0:P.description}}};var T,M,O,j,A;i.parameters={...i.parameters,docs:{...(T=i.parameters)==null?void 0:T.docs,source:{originalSource:`{
  args: {
    label: 'Label',
    error: 'Error',
    placeholder: 'Error'
...
}`,...(O=(M=i.parameters)==null?void 0:M.docs)==null?void 0:O.source},description:{story:"Sử dụng thuộc tính `error` của `hn-textarea` để thay đổi error của nó.",...(A=(j=i.parameters)==null?void 0:j.docs)==null?void 0:A.description}}};var G,U,J,Q,W;o.parameters={...o.parameters,docs:{...(G=o.parameters)==null?void 0:G.docs,source:{originalSource:`{
  args: {
    label: 'Label',
    disabled: true,
